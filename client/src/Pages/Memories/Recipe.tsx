  ...
  return (
    <MemoryContainer
      ...
      <Container mobileWidth="60%" width="70%">
        <div className=" flex flex-wrap content-start mt-6 md:mt-12 md:mb-4 md:w-[100%]">
          <div className="md:w-[70%]">
            <h2 className="mb-1 block font-[Fondamento] text-[#654A2F] text-[15px] md:text-[35px] mx-3 md:ml-10 md:mb-5">
              {recipe?.dishName}
            </h2>

            {/* <img src="/recipe.png" className="rounded-xl w-[40%]" /> */}
          </div>
          <div className="md:w-[30%]">
            <div className="flex items-center justify-start md:my-2 ml-30 md:mr-8">
        ...
        <div className="flex flex-wrap justify-center mb-5">
          <div className="md:w-[50%] md:px-5 md:pt-2 mb-1 md:my-[10px] md:mx-auto mt-3">
            ...
            focus:outline-none text-[16px] md:py-3 pr-4 md:mt-3">
              {recipe?.ingredients.split(',').map((ingredient, index) => (
                <li
                  key={index}
                  className="font-[Lato] text-[#654A2F] text-[10px] md:text-[18px] list-disc my-1 md:my-2 ml-4 md:ml-8 md:pl-1">
                  {ingredient}
                </li>
              ))}
            </ul>
          ...
          <div className="w-[90%] md:w-[50%] md:px-5 md:pt-2 mb-1 md:my-[10px] md:mx-auto mt-3">
            ...
            <ul
              className="block border md:border-2 border-[#654A2F]
            rounded md:rounded-md focus:border-2 md:focus:border-3
            focus:outline-none text-[16px] py-1 md:py-3 pr-4 mt-1 md:mt-3">
              {recipe?.directions.split('.').map((direction, index) => (
                <li
                  key={index}
                  className="font-[Lato] text-[#654A2F] text-[10px] md:text-[18px] list-decimal my-1 md:my-2 ml-4 md:ml-8 md:pl-1">
                  {direction}.
                </li>
              ))}
            </ul>
          ...
          <div className="w-[90%] md:w-[100%] md:px-5 md:pt-2 mb-1 md:my-[10px] md:mx-auto mt-3">
            ...
            <p
              className="font-[Lato] text-[#654A2F] text-[10px] md:text-[18px] border md:border-2 border-[#654A2F]
            rounded md:rounded-md focus:border-2 md:focus:border-3
